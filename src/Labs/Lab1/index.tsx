        ...
        <div id="wd-lab1">
            ...
            <div id="wd-lists">
                 ...
                 <ol id="wd-your-favorite-recipe">
                     <li>Boil pasta in salted water for 12 minutes.</li>
                     <li>Saute garlic and onions with olive oil in a pan.</li>
                     <li>Mix in tomato sauce, basil</li>
                     <li>Add pasta and mix them.</li>
                </ol>
            ...
            <a id="wd-github" href="https://github.com/lyle95/kanbas-react-web-app.git">Code Repository on Github</a>
        </div>
    );
}