...
export default function WorkingWithArrays() {
    ...
    return (
        <div id="wd-working-with-arrays">
            ...
            <br /><br /><hr />
            <h4>Editing a completed in an Array</h4>
            <a id="wd-edit-completed" className="btn btn-primary float-end" 
